...
//        root.setPrefSize(1000, 600);
        ...
        enemyBoard = new Board(true, event -> {
            if (!running)
                return;
            Media media1 = new Media(getClass().getResource("/sound/ex.wav").toString());
            MediaPlayer mediaPlayer1 = new MediaPlayer(media1);
            mediaPlayer1.setVolume(5);
            Media media2 = new Media(getClass().getResource("/sound/ww.wav").toString());
            ...
            if(cell.ship!=null) mediaPlayer1.play();
            if(cell.ship==null) mediaPlayer2.play();
